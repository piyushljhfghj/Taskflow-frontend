...
// import { ListChecks, Plus, Filter, Clock } from 'lucide-react'
...
//         <div>
//           <h1 className='text-2xl md:text-3xl font-bold text-grey-800 flex-items-center gap-2'>
//             <ListChecks className='text-purple-500' /> Pending Task
//           </h1>
//           <p className='text-sm text-grey-500 mt-1 ml-7'>
...
//           <div className='flex item-center gap-2 text-gray-700 font-medium'>
...
//           <div className='w-8 h-8 rounded-full bg-white flex items items-center justify-center shadow-sm group-hover:shadow-md transition-all duration-200'>
...
//               t.completed
//             )}
//             onEdit={() => { setSelectedTasks(task); setShowModal(true); }}
